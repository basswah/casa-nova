...
const mockProducts: PosProduct[] = [
  { id: '1', name: 'Espresso Beans', sku: 'ESP-001', price_usd: 25.00, price_syp: 312500, quantity: 10, is_consignment: false },
  { id: '2', name: 'Latte Cup', sku: 'LAT-002', price_usd: 10.00, price_syp: 125000, quantity: 0, is_consignment: false },
  { id: '3', name: 'Moka Pot', sku: null, price_usd: 45.00, price_syp: 562500, quantity: 5, is_consignment: false },
];
